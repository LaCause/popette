  ...
  return (
    <main className="bg-[var(--color-background)] text-[var(--color-on-background)] py-16 px-6 sm:px-8 lg:px-16">
      ...
      <article className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="mt-12">
          <p className="text-sm font-body text-[var(--color-on-background)]/60 mb-4 uppercase tracking-widest">
          ...
          <div className="flex gap-3 flex-wrap">
            <a
              ...
              className="flex items-center gap-2 rounded-full px-4 py-2 bg-[var(--color-primary-container)] text-[var(--color-on-primary-container)] hover:bg-[var(--color-primary)] hover:text-[var(--color-on-primary)] transition font-body text-sm"
            >
