    ...
    <main className="bg-[var(--color-background)] text-on-tertiary-container py-16 px-6 sm:px-8 lg:px-16">
      ...
      <article className="max-w-3xl mx-auto space-y-8">
        <header className="space-y-4">
          ...
          <p className="text-base font-body text-on-tertiary-container/70">
            Publié le{" "}
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-wrap">
            <a
              ...
              className="flex items-center gap-2 rounded-full px-4 py-2 bg-primary-container text-on-primary-container hover:bg-primary hover:text-on-primary transition font-body text-sm"
            >
