  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="typography-tertiary-xl text-8xl sm:text-9xl md:text-[200px] tracking-wide leading-tight drop-shadow-sm text-primary">
            Popette
          </h1>
          ...
          <CurvedText
            ...
            className="uppercase typography-primary-xl font-semibold"
          />
